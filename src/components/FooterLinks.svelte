...
<p>Scrawl-canvas version 8.13.2 - released 15 July 2024. Please raise issues in Github, or the Discord channel.</p>
<nav>
    <div>
        <a href="/">Tour</a>
    ...
    <div>
        ...
        <a download href="/downloads/scrawl-canvas_8-13-2.zip">Download v8.13.2</a>
    </div>
    <div>
