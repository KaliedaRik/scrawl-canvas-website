...
<p>Scrawl-canvas version 8.7.0 - released 15 Jan 2022. Please raise issues in the Discord channel, or Github.</p>
<nav>
    <div>
        <a href="/">Tour</a>
    ...
    <div>
        ...
        <a download href="/downloads/scrawl-canvas_8-7-0.zip">Download v8.7.0</a>
    </div>
    <div>
