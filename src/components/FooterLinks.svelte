...
<p>Scrawl-canvas version 8.10.0 - released 18 March 2023. Please raise issues in the Discord channel, or Github.</p>
<nav>
    <div>
        <a href="/">Tour</a>
    ...
    <div>
        ...
        <a download href="/downloads/scrawl-canvas_8-10-0.zip">Download v8.10.0</a>
    </div>
    <div>
