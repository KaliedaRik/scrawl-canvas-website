...
<p>Scrawl-canvas version 8.9.0 - released 16 Jun 2022. Please raise issues in the Discord channel, or Github.</p>
<nav>
    <div>
        <a href="/">Tour</a>
    ...
    <div>
        ...
        <a download href="/downloads/scrawl-canvas_8-9-0.zip">Download v8.9.0</a>
    </div>
    <div>
