...
<p>Scrawl-canvas version 8.17.0 - released 3 January 2026. Please raise issues in Github, or the Discord channel.</p>
<nav>
    <div>
        <a href="/">Tour</a>
    ...
    <div>
        ...
        <a download href="/downloads/scrawl-canvas_8-17-0.zip">Download v8.17.0</a>
    </div>
    <div>
