...
<p>Scrawl-canvas version 8.8.1 - released 27 Mar 2022. Please raise issues in the Discord channel, or Github.</p>
<nav>
    <div>
        <a href="/">Tour</a>
    ...
    <div>
        ...
        <a download href="/downloads/scrawl-canvas_8-8-1.zip">Download v8.8.1</a>
    </div>
    <div>
