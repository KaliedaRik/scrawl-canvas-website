...
<style>
    ...
    a {
        @apply block text-sm text-center m-0 text-gray-200 no-underline;
...
<p>Scrawl-canvas version 8.9.10 - released 27 February 2023. Please raise issues in the Discord channel, or Github.</p>
<nav>
    <div>
        <a href="/">Tour</a>
    ...
    <div>
        ...
        <a download href="/downloads/scrawl-canvas_8-9-10.zip">Download v8.9.10</a>
    </div>
    <div>
