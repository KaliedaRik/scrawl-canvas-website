...
<p>Scrawl-canvas version 8.13.1 - released 3 May 2024. Please raise issues in the Discord channel, or Github.</p>
<nav>
    <div>
        <a href="/">Tour</a>
    ...
    <div>
        ...
        <a download href="/downloads/scrawl-canvas_8-13-1.zip">Download v8.13.1</a>
    </div>
    <div>
