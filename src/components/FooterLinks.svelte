...
<p>Scrawl-canvas version 8.9.3 - released 9 Aug 2022. Please raise issues in the Discord channel, or Github.</p>
<nav>
    <div>
        <a href="/">Tour</a>
    ...
    <div>
        ...
        <a download href="/downloads/scrawl-canvas_8-9-3.zip">Download v8.9.3</a>
    </div>
    <div>
