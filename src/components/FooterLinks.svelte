...
<p>Scrawl-canvas version 8.8.0 - released 2 Feb 2022. Please raise issues in the Discord channel, or Github.</p>
<nav>
    <div>
        <a href="/">Tour</a>
    ...
    <div>
        ...
        <a download href="/downloads/scrawl-canvas_8-8-0.zip">Download v8.8.0</a>
    </div>
    <div>
